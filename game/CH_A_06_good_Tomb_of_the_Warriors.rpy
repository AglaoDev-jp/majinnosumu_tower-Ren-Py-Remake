# CH_A_06_good_Tomb_of_the_Warriors

label CH_A_06_good_Tomb_of_the_Warriors:
    ...
    voice "audio/voice/a/06g/0_6_「それでも.mp3"
    extend "「それでも、この者が剣を手にしているということは、この剣が導いたのだろう。"
    ...
    voice "audio/voice/a/06g/0_10_「お願いだ.mp3"
    extend "「お願いだ。この剣をフィオリス王国に届けて欲しい。"
    voice "audio/voice/a/06g/0_11_これは王国.mp3"
    extend "これは王国にとって、かけがえのない遺産なのだ。"
    ...
    narrator_arrow "戦士たちは再び静かな敬意を持ってあなたを見つめ、次に進むべき道を示す。\n"
    ...
    voice "audio/voice/a/06g/0_18_「門を開く.mp3"
    extend "「門を開くには、三つの試練を克服する必要がある。"
    voice "audio/voice/a/06g/0_19_門の両脇に.mp3"
    extend "門の両脇にある石碑に隠された呪文を唱え、門の魔力を弱めることが第一だ。"
    ...
    narrator_arrow "最後に、年老いた戦士の霊が、あなたに向かって忠告する。\n"
    voice "audio/voice/a/06g/0_26_「門を開い.mp3"
    extend "「門を開いた後も、油断は禁物だ。"
    voice "audio/voice/a/06g/0_27_その先には.mp3"
    extend "その先には魔人の生き残りが待ち構えているやもしれぬ。"
    voice "audio/voice/a/06g/0_28_しかし、剣.mp3"
    extend "しかし、剣に宿る力を信じれば、必ず道は開かれる。"
    voice "audio/voice/a/06g/0_29_我らの希望.mp3"
    extend "我らの希望を託す…どうか、無事に王国に剣を届けてくれ。」\n"
